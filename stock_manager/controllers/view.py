"""
View controller for displaying inventory data
...
class View(AbstractController):
    """
    Controller for the 'View' page of
    the stock management application.

    Handles displaying inventory data and
    navigation to `export.ui` and `export.py`.
    """
    ...
    def handle_connections(self) -> None:
        ...
        self.export_btn.clicked.connect(
            lambda: self.app.export.to_page()
