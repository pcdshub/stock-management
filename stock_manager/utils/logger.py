...
Logger can be used by referencing `logging.getLogger()`
after `Logger()` is run.
"""
...
class Logger:
    """
    Logger utility for writing informational, warning,
    and error logs to a file and the console.
    """

    def __init__(self):
        """
        Configures the logging module to write logs to 'app.log'
