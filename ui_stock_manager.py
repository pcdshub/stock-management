...
################################################################################
## Form generated from reading UI file 'stock_managerqNPWPY.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u"../../bin/images/slac_logo.jpg", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"PAGE | SLAC Inventory Management Application", None))
